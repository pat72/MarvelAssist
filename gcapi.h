/* gcapi.h
 *
 * Copyright (c) 2011-2015 ConsoleTuner
 *
 * This file is part of Gtuner Project
 * http://www.consoletuner.com
 *
 * Gtuner compatible devices provides an open programming interface 
 * for computer applications receive input data from game controllers
 * and send commands to console (PS4, XBox One, PS3 and XBox360).
 *
 * This header defines the directives used by the plugin API (Gtuner.exe) 
 * and by the Direct API (gcdapi.dll).
 *
 * Changes:
 ...
 * 05-May-2014: Added support for Titan One Device.
 * 05-Jan-2015: Added LoadDevice functions for Direct API.
 */
 ...
 *
 *  IsConnected   - Check if a device is connected
